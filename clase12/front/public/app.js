...
form.addEventListener('submit', e =>{
    ...
    let msgData = {
        usuario: e.target.sendUsu.value,
...
function createDiv (data){
    ...
    div.innerHTML = `<p class="bluetext">${data.usuario}</p> <div class="flex">[<p class="redtext"> ${data.fecha} </p>] :</div> <p class="greentext">${data.mensaje}</p> `
